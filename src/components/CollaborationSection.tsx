...
export function CollaborationSection() {
    return (
        <section className="py-32 bg-slate-50 dark:bg-slate-950 relative border-t border-slate-200/60 dark:border-slate-800/60">
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="max-w-3xl mb-24 mt-10">
                    ...
                    <motion.h2
                        ...
                        className="text-5xl md:text-7xl font-bold text-slate-900 dark:text-white leading-[1.1] mb-8 tracking-tight"
                    >
                        Kolaborasi Tim <br />
                    ...
                    <motion.p
                        ...
                        className="text-xl md:text-2xl text-slate-500 dark:text-slate-400 max-w-2xl leading-relaxed font-light"
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 mb-8">
                    ...
                    <motion.div
                        ...
                        className="col-span-1 md:col-span-7 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-[2.5rem] p-10 md:p-12 border border-white dark:border-slate-800 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.1)] transition-all duration-500 overflow-hidden group relative flex flex-col justify-between h-[600px]"
                    >
                        ...
                        <div className="mb-10 relative z-10 block">
                            ...
                            <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-4 tracking-tight">Project Management</h3>
                    ...
                    <motion.div
                        ...
                        className="col-span-1 md:col-span-5 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-[2.5rem] p-10 md:p-12 border border-white dark:border-slate-800 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.1)] transition-all duration-500 overflow-hidden group relative flex flex-col justify-between h-[600px]"
                    >
                        ...
                        <div className="mb-10 relative z-10 block">
                            ...
                            <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-4 tracking-tight">Status Updates</h3>
                ...
                >
                    ...
                    <div className="w-full md:w-1/3 flex flex-col justify-center relative z-10">
                        ...
                        <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-6 tracking-tight">Dokumen Hidup</h3>
